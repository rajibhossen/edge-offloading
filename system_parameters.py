parameter = {
    ...
    "w1": 0.25, # weight factor for time
    "w2": 15.875, # weight factor for money
    ...
    "cloud_cps": 0.00166667*3,  # aws lambda price in cents, $0.0000166667 per gb-sec, for 3 GB
    ...
    "max_penalty": -500,  # maximum penalty if violates constraint
